...
| Core Math | add, subtract, multiply, divide, sqrt, exp, log, sin/cos/tan, power, mod, fmod, reciprocal, positive, negative, abs, absolute, sign, square, cbrt, ldexp, floor, ceil | 56+ |
