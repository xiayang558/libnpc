...
Array* log_array(Array *arr) {
    ...
    switch (arr->dtype) {
        NP_INT_LOG_OP(INT8,int8_t,log,"") NP_INT_LOG_OP(INT16,int16_t,log,"")
        NP_INT_LOG_OP(INT32,int32_t,log,"") NP_INT_LOG_OP(INT64,int64_t,log,"")
        NP_UINT_LOG_OP(UINT8,uint8_t,log,"") NP_UINT_LOG_OP(UINT16,uint16_t,log,"")
        NP_UINT_LOG_OP(UINT32,uint32_t,log,"") NP_UINT_LOG_OP(UINT64,uint64_t,log,"")
        NP_FLOAT_LOG_OP(FLOAT32,float,log,"") NP_FLOAT_LOG_OP(FLOAT64,double,log,"")
        NP_COMPLEX_LOG_OP(COMPLEX64,complex float,clog,0.0+0.0*I,"")
        NP_COMPLEX_LOG_OP(COMPLEX128,complex double,clog,0.0+0.0*I,"")
        NP_LONG_COMPLEX_LOG_OP(COMPLEX256,long double complex,clogl,0.0L+0.0L*I,"")
