...
I18N.modules = {
  ...
  manip:   { name:'数组操作', desc:'clip、choose、compress、delete、extract、insert、put、around 等。' },
...
I18N.fn = {
  ...
  delete:   { desc:'沿指定轴删除子数组并返回新数组。类似 numpy.delete。' , ret:'具有 obj entries removed along axis 的新数组', params:['输入','INT64 indices to delete','Axis to delete along']},
