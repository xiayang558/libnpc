...
delete: { m:'manip', sig:'Array* delete(Array *arr, Array *obj, int axis)', desc:'Return new array with sub-arrays deleted along axis.', params:[['arr','Array*','Input'],['obj','Array*','INT64 indices to delete'],['axis','int','Axis to delete along']], ret:'New array with obj entries removed along axis.', example:`Array *trimmed = delete(A, indices, 0);  // remove rows`, rel:['insert','append'] },
...
insert: { m:'manip', sig:'Array* insert(Array *arr, Array *obj, Array *values, int axis)', desc:'Insert values before the given indices along axis.', params:[['arr','Array*','Input'],['obj','Array*','INT64 indices (where to insert before)'],['values','Array*','Values to insert (must match along other axes)'],['axis','int','Axis']], ret:'New array with values inserted.', example:`Array *expanded = insert(A, positions, newRows, 0);`, rel:['delete','append','concatenate'] },
