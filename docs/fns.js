...
ndim: { m:'utils', sig:'int ndim(Array *a)', desc:'Return number of array dimensions. Like numpy.ndim.', params:[['a','Array*','Input array']], ret:'Number of dimensions (int).', notes:'Returns a->ndim directly. Returns -1 for NULL.', example:`int d = ndim(A);`, rel:['asize','array_info'] },
...
npc_ldexp: { m:'arith', sig:'Array* npc_ldexp(Array *x, Array *exp)', desc:'Return x * 2**exp element-wise. Like numpy.ldexp.', params:[['x','Array*','Input values (any numeric)'],['exp','Array*','Exponents (must be integer type)']], ret:'FLOAT64 array of broadcast shape.', notes:'Named npc_ldexp to avoid math.h ldexp() conflict.', example:`Array *r = npc_ldexp(a, exps);`, rel:['power','npc_frexp'] },
reciprocal: { m:'arith', sig:'Array* reciprocal(Array *x)', desc:'Return 1/x element-wise. Like numpy.reciprocal.', params:[['x','Array*','Input array (any dtype)']], ret:'FLOAT64 for int input; same float/complex type otherwise.', notes:'Division by zero produces INF. Integer inputs promoted to FLOAT64.', example:`Array *r = reciprocal(a);`, rel:['divide','true_divide'] },
positive: { m:'arith', sig:'Array* positive(Array *x)', desc:'Return +x (numeric copy). Like numpy.positive.', params:[['x','Array*','Input array (any dtype)']], ret:'New array, same shape and dtype as input.', notes:'Always returns a deep copy.', example:`Array *r = positive(a);`, rel:['negative','copy','astype'] },
negative: { m:'arith', sig:'Array* negative(Array *x)', desc:'Return -x element-wise. Like numpy.negative.', params:[['x','Array*','Input array (any dtype)']], ret:'New array; INT64 for integer input, same type for float/complex.', notes:'Integer inputs promoted to INT64 (like numpy).', example:`Array *r = negative(a);`, rel:['positive','subtract','multiply_scalar'] },
fmod_arr: { m:'arith', sig:'Array* fmod_arr(Array *x1, Array *x2)', desc:'Return C-style remainder (toward zero) element-wise. Like numpy.fmod.', params:[['x1','Array*','Dividend array'],['x2','Array*','Divisor array']], ret:'FLOAT64 array of broadcast shape.', notes:'Result sign matches dividend (x1). Named fmod_arr to avoid math.h fmod() conflict.', example:`Array *r = fmod_arr(a, b);`, rel:['mod','mod_scalar'] },
npc_cbrt: { m:'arith', sig:'Array* npc_cbrt(Array *x)', desc:'Return cube root element-wise. Like numpy.cbrt.', params:[['x','Array*','Input array (any real)']], ret:'FLOAT64 array, same shape.', notes:'Negative inputs produce real negative roots. Named npc_cbrt to avoid math.h cbrt() conflict.', example:`Array *r = npc_cbrt(a);`, rel:['sqrt_array','power','square'] },
square: { m:'arith', sig:'Array* square(Array *x)', desc:'Return x**2 element-wise. Like numpy.square.', params:[['x','Array*','Input array (any dtype)']], ret:'INT64 for integer input; same type for float/complex.', example:`Array *r = square(a);`, rel:['power','npc_cbrt','sqrt_array','multiply'] },
absolute: { m:'arith', sig:'Array* absolute(Array *x)', desc:'Return |x| element-wise. Like numpy.absolute.', params:[['x','Array*','Input (any dtype, including complex)']], ret:'Same dtype as input; real absolute value for complex.', notes:'Alias for abs_array.', example:`Array *r = absolute(a);`, rel:['abs_array','fabs_array','sign'] },
pow_arr: { m:'arith', sig:'Array* pow_arr(Array *x1, Array *x2)', desc:'Return x1**x2 element-wise. Like numpy.power.', params:[['x1','Array*','Base array'],['x2','Array*','Exponent array']], ret:'FLOAT64 array of broadcast shape.', notes:'Alias for power(). Named pow_arr to avoid math.h pow() conflict.', example:`Array *r = pow_arr(a, b);`, rel:['square','npc_cbrt','power'] },
...
npc_frexp: { m:'fp', sig:'int npc_frexp(Array *x, Array **mant, Array **exp)', desc:'Split each element into mantissa and exponent. Like numpy.frexp.', params:[['x','Array*','Input'],['mant','Array**','Output mantissa (0.5 to <1 magnitude)'],['exp','Array**','Output exponent (INT32)']], ret:'0 on success.', notes:'Alias for frexp_array. Named npc_frexp to avoid math.h frexp() conflict.', example:`Array *m=NULL,*e=NULL; npc_frexp(a,&m,&e);`, rel:['npc_ldexp','modf_arr','frexp_array'] },
spacing: { m:'fp', sig:'Array* spacing(Array *x)', desc:'Return distance to next adjacent floating-point value. Like numpy.spacing.', params:[['x','Array*','Input array']], ret:'FLOAT64 array, same shape.', notes:'Alias for spacing_array.', example:`Array *r = spacing(a);`, rel:['nextafter_array','fabs_array'] },
modf_arr: { m:'arith', sig:'int modf_arr(Array *x, Array **frac, Array **integ)', desc:'Split each element into fractional and integer parts. Like numpy.modf.', params:[['x','Array*','Input'],['frac','Array**','Output fractional part'],['integ','Array**','Output integer part']], ret:'0 on success.', notes:'Alias for modf_array. Returns frac+integ via pointer outputs.', example:`Array *f=NULL,*i=NULL; modf_arr(a,&f,&i);`, rel:['npc_frexp','floor_array','atrunc'] },
